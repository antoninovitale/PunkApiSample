 ...
 */
class DynamicConfig private constructor(
    ...
    class Builder {
        ...
        var isSuffixTextBold: Boolean? = null
         ...
         */
        fun setSuffixLRMargin(
                margin: Float): Builder {
            suffixLRMargin = margin
            return this
        }

        fun setSuffixDayLeftMargin(
                margin: Float): Builder {
            suffixDayLeftMargin = margin
            return this
        }

        fun setSuffixDayRightMargin(
                margin: Float): Builder {
            suffixDayRightMargin = margin
            return this
        }

        fun setSuffixHourLeftMargin(
                margin: Float): Builder {
            suffixHourLeftMargin = margin
            return this
        }

        fun setSuffixHourRightMargin(
                margin: Float): Builder {
            suffixHourRightMargin = margin
            return this
        }

        fun setSuffixMinuteLeftMargin(
                margin: Float): Builder {
            suffixMinuteLeftMargin = margin
            return this
        }

        fun setSuffixMinuteRightMargin(
                margin: Float): Builder {
            suffixMinuteRightMargin = margin
            return this
        }

        fun setSuffixSecondLeftMargin(
                margin: Float): Builder {
            suffixSecondLeftMargin = margin
            return this
        }

        fun setSuffixSecondRightMargin(
                margin: Float): Builder {
            suffixSecondRightMargin = margin
            return this
        }

        fun setSuffixMillisecondLeftMargin(
                margin: Float): Builder {
         ...
         */
        fun setSuffixGravity(
                suffixGravity: Int): Builder {
         ...
         */
        fun setConvertDaysToHours(
                isConvertDaysToHours: Boolean): Builder {
         ...
         */
        fun setShowMillisecond(
                isShowMillisecond: Boolean?): Builder {
         ...
         */
        fun setBackgroundInfo(
                backgroundInfo: BackgroundInfo?): Builder {
