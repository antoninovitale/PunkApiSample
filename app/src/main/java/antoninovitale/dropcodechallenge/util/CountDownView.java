...
public class CountDownView extends RelativeLayout {
    ...
    public CountDownView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int numColorId = values.getResourceId(R.styleable.CountDownView_numberColor, android.R
                .attr.textColor);
        int unitColorId = values.getResourceId(R.styleable.CountDownView_unitColor, android.R
                .attr.textColor);

        if (values.getBoolean(R.styleable.CountDownView_showHour, false)) {
            View v = ((ViewStub) findViewById(R.id.hours_stub)).inflate();
            mHours = v.findViewById(R.id.hours);
            ((TextView) v.findViewById(R.id.hours_unit)).setTextColor(ContextCompat
                    .getColorStateList(context, unitColorId));
            mHours.setTextColor(ContextCompat.getColorStateList(context, numColorId));
        }
        ...
        if (values.getBoolean(R.styleable.CountDownView_showMin, false)) {
            ...
            ((TextView) v.findViewById(R.id.minutes_unit)).setTextColor(ContextCompat
                    .getColorStateList(context, unitColorId));
            mMinutes.setTextColor(ContextCompat.getColorStateList(context, numColorId));
        }
        ...
        if (values.getBoolean(R.styleable.CountDownView_showSec, false)) {
            ...
            ((TextView) v.findViewById(R.id.seconds_unit)).setTextColor(ContextCompat
                    .getColorStateList(context, unitColorId));
            mSeconds.setTextColor(ContextCompat.getColorStateList(context, numColorId));
        }
        ...
        if (values.getBoolean(R.styleable.CountDownView_showMilli, false)) {
            ...
            mMilliseconds = v.findViewById(R.id.milliseconds);
            ((TextView) v.findViewById(R.id.milliseconds_unit)).setTextColor(ContextCompat
                    .getColorStateList(context, unitColorId));
            mMilliseconds.setTextColor(ContextCompat.getColorStateList(context, numColorId));
        }
        values.recycle();
    }
     ...
     *
     * @param assetPath - Relative path under assets directory. i.e. "sounds/Timer_Expire.ogg"
     */
