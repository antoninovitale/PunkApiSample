...
class BackgroundCountdown extends BaseCountdown {
    ...
    private RectF mDayBgBorderRectF, mHourBgBorderRectF, mMinuteBgBorderRectF,
            mSecondBgBorderRectF, mMillisecondBgBorderRectF;
    ...
    public void initStyleAttr(Context context, TypedArray ta) {
        ...
        mTimeBgColor = ta.getColor(R.styleable.CountdownView_timeBgColor,
                0xFF444444);
        mTimeBgRadius = ta.getDimension(R.styleable
                .CountdownView_timeBgRadius, 0);
        isShowTimeBgDivisionLine = ta.getBoolean(R.styleable
                .CountdownView_isShowTimeBgDivisionLine, true);
        mTimeBgDivisionLineColor = ta.getColor(R.styleable
                .CountdownView_timeBgDivisionLineColor, Color.parseColor("#30FFFFFF"));
        mTimeBgDivisionLineSize = ta.getDimension(R.styleable
                .CountdownView_timeBgDivisionLineSize, Utils.dp2px(context,
                DEFAULT_TIME_BG_DIVISION_LINE_SIZE));
        mTimeBgSize = ta.getDimension(R.styleable
                .CountdownView_timeBgSize, 0);
        mDefSetTimeBgSize = mTimeBgSize;
        mTimeBgBorderSize = ta.getDimension(R.styleable
                .CountdownView_timeBgBorderSize, Utils.dp2px(context, DEFAULT_TIME_BG_BORDER_SIZE));
        mTimeBgBorderRadius = ta.getDimension(R.styleable
                .CountdownView_timeBgBorderRadius, 0);
        mTimeBgBorderColor = ta.getColor(R.styleable
                .CountdownView_timeBgBorderColor, 0xFF000000);
        isShowTimeBgBorder = ta.getBoolean(R.styleable
                .CountdownView_isShowTimeBgBorder, false);

        isDrawBg = ta.hasValue(R.styleable.CountdownView_timeBgColor) ||
                !isShowTimeBgBorder;
    }
    ...
    private void initTimeBgRect(float topPaddingSize) {
        ...
        if (isShowDay) {
            ...
            if (isShowTimeBgBorder) {
                mDayBgBorderRectF = new RectF(mLeftPaddingSize, topPaddingSize, mLeftPaddingSize
                        + mDayTimeBgWidth + (mTimeBgBorderSize * 2), topPaddingSize + mTimeBgSize
                        + (mTimeBgBorderSize * 2));
                mDayBgRectF = new RectF(mLeftPaddingSize + mTimeBgBorderSize, topPaddingSize +
                        mTimeBgBorderSize, mLeftPaddingSize + mDayTimeBgWidth +
                        mTimeBgBorderSize, topPaddingSize + mTimeBgSize + mTimeBgBorderSize);
            } else {
                mDayBgRectF = new RectF(mLeftPaddingSize, topPaddingSize, mLeftPaddingSize +
        ...
        if (isShowHour) {
            ...
            if (isShowTimeBgBorder) {
                mHourBgBorderRectF = new RectF(mHourLeft, topPaddingSize, mHourLeft + mTimeBgSize
                        + (mTimeBgBorderSize * 2), topPaddingSize + mTimeBgSize +
                        (mTimeBgBorderSize * 2));
                mHourBgRectF = new RectF(mHourLeft + mTimeBgBorderSize, topPaddingSize +
                        mTimeBgBorderSize, mHourLeft + mTimeBgSize + mTimeBgBorderSize,
                        topPaddingSize + mTimeBgSize + mTimeBgBorderSize);
            } else {
                mHourBgRectF = new RectF(mHourLeft, topPaddingSize, mHourLeft + mTimeBgSize,
        ...
        if (isShowMinute) {
            ...
            if (isShowTimeBgBorder) {
                mMinuteBgBorderRectF = new RectF(mMinuteLeft, topPaddingSize, mMinuteLeft +
                        mTimeBgSize + (mTimeBgBorderSize * 2), topPaddingSize + mTimeBgSize +
                        (mTimeBgBorderSize * 2));
                mMinuteBgRectF = new RectF(mMinuteLeft + mTimeBgBorderSize, topPaddingSize +
                        mTimeBgBorderSize, mMinuteLeft + mTimeBgSize + mTimeBgBorderSize,
                        topPaddingSize + mTimeBgSize + mTimeBgBorderSize);
            } else {
                mMinuteBgRectF = new RectF(mMinuteLeft, topPaddingSize, mMinuteLeft +
        ...
        if (isShowSecond) {
            ...
            if (isShowTimeBgBorder) {
                mSecondBgBorderRectF = new RectF(mSecondLeft, topPaddingSize, mSecondLeft +
                        mTimeBgSize + (mTimeBgBorderSize * 2), topPaddingSize + mTimeBgSize +
                        (mTimeBgBorderSize * 2));
                mSecondBgRectF = new RectF(mSecondLeft + mTimeBgBorderSize, topPaddingSize +
                        mTimeBgBorderSize, mSecondLeft + mTimeBgSize + mTimeBgBorderSize,
                        topPaddingSize + mTimeBgSize + mTimeBgBorderSize);
            } else {
                mSecondBgRectF = new RectF(mSecondLeft, topPaddingSize, mSecondLeft +
                        mTimeBgSize, topPaddingSize + mTimeBgSize);
            }
            ...
            if (isShowMillisecond) {
                ...
                if (isShowTimeBgBorder) {
                    mMillisecondBgBorderRectF = new RectF(mMillisecondLeft, topPaddingSize,
                            mMillisecondLeft + mTimeBgSize + (mTimeBgBorderSize * 2),
                            topPaddingSize + mTimeBgSize + (mTimeBgBorderSize * 2));
                    mMillisecondBgRectF = new RectF(mMillisecondLeft + mTimeBgBorderSize,
                            topPaddingSize + mTimeBgBorderSize, mMillisecondLeft + mTimeBgSize +
                            mTimeBgBorderSize, topPaddingSize + mTimeBgSize + mTimeBgBorderSize);
                } else {
                    mMillisecondBgRectF = new RectF(mMillisecondLeft, topPaddingSize,
    ...
    private void initHasBackgroundTextBaseY(RectF rectF) {
        ...
        mTimeBgDivisionLineYPos = rectF.centerY() + (mTimeBgDivisionLineSize == Utils.dp2px
                (mContext, DEFAULT_TIME_BG_DIVISION_LINE_SIZE) ? mTimeBgDivisionLineSize :
     ...
     */
    private float initTimeTextBaselineAndTimeBgTopPadding(int viewHeight, int viewPaddingTop, int
            viewPaddingBottom, int contentAllHeight) {
    ...
    @Override
    public void onMeasure(View v, int viewWidth, int viewHeight, int allContentWidth, int
            allContentHeight) {
        float retTopPaddingSize = initTimeTextBaselineAndTimeBgTopPadding(viewHeight, v
                .getPaddingTop(), v.getPaddingBottom(), allContentHeight);
        mLeftPaddingSize = v.getPaddingLeft() == v.getPaddingRight() ? (viewWidth -
                allContentWidth) / 2 : v.getPaddingLeft();
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (isShowDay) {
            ...
            // draw day text
            canvas.drawText(Utils.formatNum(mDay), mDayBgRectF.centerX(), mTimeTextBaseY,
                    mTimeTextPaint);
        ...
        if (isShowHour) {
            ...
            // draw hour text
            canvas.drawText(Utils.formatNum(mHour), mHourBgRectF.centerX(), mTimeTextBaseY,
                    mTimeTextPaint);
        ...
        if (isShowMinute) {
            ...
            // draw minute text
            canvas.drawText(Utils.formatNum(mMinute), mMinuteBgRectF.centerX(), mTimeTextBaseY,
                    mTimeTextPaint);
        ...
        if (isShowSecond) {
            ...
            // draw second text
            canvas.drawText(Utils.formatNum(mSecond), mSecondBgRectF.centerX(), mTimeTextBaseY,
                    mTimeTextPaint);
            if (mSuffixSecondTextWidth > 0) {
                // draw second suffix
            ...
            if (isShowMillisecond) {
                ...
                canvas.drawText(Utils.formatMillisecond(mMillisecond), mMillisecondBgRectF
                        .centerX(), mTimeTextBaseY, mTimeTextPaint);
