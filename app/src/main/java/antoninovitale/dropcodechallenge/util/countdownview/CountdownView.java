...
public class CountdownView extends View {
    ...
    public boolean isTimerRunning() {
        return null != mCustomCountDownTimer && mCustomCountDownTimer.isRunning();
    }

    public boolean isTimerPaused() {
        return null != mCustomCountDownTimer && mCustomCountDownTimer.isPaused();
    }

    public boolean isTimerStopped() {
        return null != mCustomCountDownTimer && mCustomCountDownTimer.isStopped();
    }
    ...
    public void customTimeShow(boolean isShowDay, boolean isShowHour, boolean isShowMinute,
        ...
        boolean isModCountdownInterval = mCountdown.refTimeShow(isShowDay, isShowHour,
     ...
     */
    public void setOnCountdownIntervalListener(long interval, OnCountdownIntervalListener
    ...
    public void dynamicShow(DynamicConfig dynamicConfig) {
        ...
        if (null != tempIsShowDay || null != tempIsShowHour || null != tempIsShowMinute || null
            ...
            boolean isShowMinute = null != tempIsShowMinute ? tempIsShowMinute : mCountdown
                    .isShowMinute;
            boolean isShowSecond = null != tempIsShowSecond ? tempIsShowSecond : mCountdown
                    .isShowSecond;
            boolean isShowMillisecond = null != tempIsShowMillisecond ? tempIsShowMillisecond :
                    mCountdown.isShowMillisecond;
        ...
        if (null != tempIsConvertDaysToHours && mCountdown.setConvertDaysToHours
                (tempIsConvertDaysToHours)) {
